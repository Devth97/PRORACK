...
export function App() {
  ...
  return <div>
    ...
    <main id="main"><span id="top"/>
      ...
      <section className="founder-message" id="founder"><div className="section-heading"><span className="section-kicker">FOUNDER’S MESSAGE</span><h2>Engineered for durability, designed for growth.</h2></div><div className="founder-grid"><blockquote className="founder-quote"><p>“When we founded ProRack, our vision was simple yet uncompromising: to transform industrial storage into a competitive advantage. Every rack we design and manufacture is engineered to maximize safety, space, and operational throughput for modern logistics.”</p><cite><strong>Khalandar Thameem</strong><span>Founder & Managing Director, ProRack Storage Solutions</span></cite></blockquote></div></section>
